        ...
        <div sytle={{ height: "256px" }}>
          <Image
            ...
            src={
              imagesrc
                ? imagesrc
                : "https://user-images.githubusercontent.com/91959791/162676899-be6a11b1-d103-4d57-89b8-34db876fad6f.png"
            }
            size="256"
          />
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "row" }}>
          ...
          <label htmlFor="raised-button-file">
            <Button component="span" style={{ width: "100px" }}>
              ...
              >
                <BsPencil
                  style={{ flexGrow: 1, width: "25px", height: "25px" }}
                />
        ...
        >
          ...
          >
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ color: "blue" }}>010-0000-0000</div>
            </div>
          </div>
          <div
            style={{
